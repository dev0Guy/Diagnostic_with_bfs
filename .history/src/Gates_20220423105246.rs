...
pub fn activate_gate(gate: &GateOptions,input: &Vec<bool>)-> bool{
    match gate{
        ...
        GateOptions::NAnd3 => !(input[0] & input[1] & input[2]),
        GateOptions::NAnd4 => !(input[0] & input[1] & input[2] & input[3]),
        GateOptions::NAnd5 => !(input[0] & input[1] & input[2] & input[3] & input[4]),
        GateOptions::Xor2 => input[0] ^ input[1],
        GateOptions::Xor3 => input[0] ^ input[1] ^ input[2],
        GateOptions::Xor4 => input[0] ^ input[1] ^ input[2] ^ input[3],
        ...
        GateOptions::NOr3 => !(input[0] | input[1] | input[2]),
        GateOptions::NOr4 => !(input[0] | input[1] | input[2] | input[3]),
        GateOptions::NOr5 => !(input[0] | input[1] | input[2] | input[3] | input[4]),
    }
}
